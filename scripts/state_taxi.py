...
#
sql = "select proj_track,state from tracks where st_intersects(proj_track,ST_PolygonFromText('POLYGON((" + str(xs_min) + " " + str(ys_min) + ", " + str(xs_max) + " " + str(ys_min) + ", " + str(xs_max) + " " + str(ys_max) + ", " + str(xs_min) + " " + str(ys_max) + "," + str(xs_min) + " " + str(ys_min)+"))',3763))"
cursor_psql.execute(sql)
results = cursor_psql.fetchall()
